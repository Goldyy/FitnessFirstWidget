...
const CLUBS = await fetchWithCache({
    url: "https://raw.githubusercontent.com/jesperschlegel/FitnessFirstWidget/refs/heads/main/assets/fitnessFirstClubs.json",
    key: "clubs",
    type: "json"
});
...
async function createWidget() {
    ...
    let image = await fetchWithCache({
        url: "https://raw.githubusercontent.com/jesperschlegel/FitnessFirstWidget/refs/heads/main/assets/fitnessFirstLogo.png",
        key: "logo",
        type: "image"
    });
